...
public class AsteroidsPhase4 implements Screen {
	
	private Stage mStage;
	
	private static AsteroidsPhase4 mInstance;
	
	public static AsteroidsPhase4 getInstance() {
		return mInstance;
	}
	
	public AsteroidsPhase4() {
		mInstance = this;
		...
		asteroidsTextActor.setText("Fase 4");		
		...
		asteroidsTextActor2.setText("Criptografia: Criptografar ou cifrar é o ato de tornar ilegível uma mensagem");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor3.setText("O oposto, ou seja, a partir da mensagem ilegível\n" + 
				"obter-se a original, é chamado de decifragem.");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor4.setText("Por que usar? Sniffers (farejadores) podem interceptar pacotes que trafegam na rede.\n" + 
				"E se os seus dados, ");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor5.setText("tais como numero do cartão de crédito,\n" + 
				"mensagens de e-mail e senhas de banco, fossem capturados");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor6.setText("e estivessem em texto claro?");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor8.setText("Na próxima fase utilize criptografia para se proteger dos sniffers!");
		 y = y - 100;
		 x = 10;
		...
		mStage.addListener(new InputListener() {
			...
			public boolean keyDown(InputEvent event, int keycode) {
				...
				AsteroidsGameScreen.getInstance().initializeGame4();
