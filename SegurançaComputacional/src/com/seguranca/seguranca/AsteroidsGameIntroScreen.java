...
public class AsteroidsGameIntroScreen implements Screen {
	...
	public AsteroidsGameIntroScreen() {
		...
		asteroidsTextActor.setText("Segurança Computacional");
		
		asteroidsTextActor.setFontHeight(Gdx.graphics.getWidth() / 15);
		...
		mStage.addListener(new InputListener() {
			...
			public boolean keyDown(InputEvent event, int keycode) {
				...
				AsteroidsGame.getInstance().setScreen(AsteroidsPhase1.getInstance());
				return true;
