...
public class AsteroidsPhase5 implements Screen {
	...
	public AsteroidsPhase5() {
		...
		asteroidsTextActor2.setText("Malicious software ou código malicioso.");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor3.setText("O malware realiza algum tipo de acão indesejada pelo usuário, rouba dados, exibe propagandas");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor5.setText("Dentre os vários tipos de Malware podemos citar: Vírus, Worm, Trojan, Spyware, Rootkit, Exploit etc.");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor6.setText("Para nos protegermos dessa ameaça podemos usar ferramentas como:\n" + 
				"antimalware, firewall, atualizações de software etc.");
		 y = y - 50;
		 x = 10;
		...
		asteroidsTextActor8.setText("Na próxima fase utilize as ferramentas citadas acima para combater os ataques de Malware!");
		 y = y - 100;
		 x = 10;
